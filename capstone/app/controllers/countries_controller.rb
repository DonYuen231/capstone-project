class CountriesController < ApplicationController
  ...
  private
    ...
    def country_params
      params.require(:country).permit(:stat, :rails, :g, :scaffold, :country_stat, :name, :mobilephones, :mortalityunder5, :healthexpenditurepercapita, :healthexpenditureppercentGDP, :population, :populationurban, :birthrate, :lifeexpectancy, :GDP)
    end
end
